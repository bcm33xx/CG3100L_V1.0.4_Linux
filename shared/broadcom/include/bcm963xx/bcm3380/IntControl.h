...
typedef struct {
  ...
  IntControlIntPeriphIrqStatus        IntPeriphIrqstatus;      
  ...
  IntControlIopIrqMask                Iopirqmask0;             
  IntControlIopIrqStatus              Iopirqstatus0;           
  IntControlIopIrqMask                Iopirqmask1;             
  IntControlIopIrqStatus              Iopirqstatus1;           
  IntControlDocsisIrqSense            DocsisIrqSense;          
  ...
  IntControlIrqOutMask                IrqOutMask;              
  IntControlDiagSelControl            Diagselcontrol;          
  uint32                              Diagreadback;            
  IntControlDiagReadBackHi            Diagreadbackhi;          
  IntControlDiagMiscControl           Diagmisccontrol;         
  IntControlSoftResetBLo              SoftresetbLo;            
