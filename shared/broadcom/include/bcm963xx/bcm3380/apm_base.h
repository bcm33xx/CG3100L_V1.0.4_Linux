...
typedef union {
  struct {
    uint32 ApmDiagHiSel                   :8; 
    uint32 AudioDiagSel                   :8; 
    uint32 Reserved                       :11;
...
typedef union {
  struct {
    uint32 Reserved                       :11;
    uint32 UbusDevTimeoutError            :1; 
                                              
    uint32 UbusReqoutPlenError            :1; 
                                              
    uint32 UbusRepinError                 :1; 
